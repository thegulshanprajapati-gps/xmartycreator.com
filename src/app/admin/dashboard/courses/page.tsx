...
import initialCoursesContent from '@/content/courses.json';
...
export default function AdminCoursesPage() {
    const [state, formAction, isPending] = useActionState(updateCoursesContent, { message: '', data: initialCoursesContent });
    const { toast } = useToast();
    const [coursesContent, setCoursesContent] = useState<CoursesContent>(initialCoursesContent);
