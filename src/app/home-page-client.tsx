  ...
  return (
    <>
        ...
        <div className="flex flex-col">
          {/* Hero Section */}
          <section className="relative w-full h-screen md:h-auto md:min-h-screen flex items-center justify-center overflow-hidden bg-background">
            ...
            <div className="container mx-auto px-4 md:px-6 relative z-10">
              <div className="grid items-center gap-6 md:grid-cols-2 md:gap-12">
                <motion.div
                    className="flex flex-col justify-center space-y-4 text-center items-center mx-auto text-white md:text-inherit"
                    initial="hidden"
                    animate="visible"
                ...
                >
                  ...
                  <div className="flex flex-col gap-2 min-[400px]:flex-row pt-4 self-center md:flex-row">
                ...
                <motion.div
                    className="relative hidden md:flex flex-col justify-center items-center"
                    initial="hidden"
                    animate="visible"
          ...
          {initialHomeContent.featuredCourses.title && (
          <motion.section 
          ...
          >
            <div className="container mx-auto px-4 md:px-6">
              ...
              <Carousel
                ...
                className="w-full max-w-md sm:max-w-2xl md:max-w-4xl lg:max-w-6xl mx-auto"
              >
                <CarouselContent>
